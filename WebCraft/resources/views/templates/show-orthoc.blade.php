...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('orthoc/images/favicon.png') }}" type="">

  <title> Orthoc </title>

  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{ asset('orthoc/css/bootstrap.css') }}" />
  ...
  <!-- font awesome style -->
  <link href="{{ asset('orthoc/css/font-awesome.min.css') }}" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="{{ asset('orthoc/css/style.css') }}" rel="stylesheet" />
  <!-- responsive style -->
  <link href="{{ asset('orthoc/css/responsive.css') }}" rel="stylesheet" />
...
<body>
  ...
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <img src="{{ asset('orthoc/images/hero-bg.png') }}" alt="">
    </div>
      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="box ">
              <div class="img-box">
                <img src="{{ asset('orthoc/images/s1.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Cardiology
          ...
          <div class="col-md-3">
            <div class="box ">
              <div class="img-box">
                <img src="{{ asset('orthoc/images/s2.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Diagnosis
          ...
          <div class="col-md-3">
            <div class="box ">
              <div class="img-box">
                <img src="{{ asset('orthoc/images/s3.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Surgery
          ...
          <div class="col-md-3">
            <div class="box ">
              <div class="img-box">
                <img src="{{ asset('orthoc/images/s4.png') }}" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  First Aid
  ...
  <section class="about_section layout_margin-bottom">
    <div class="container  ">
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="{{ asset('orthoc/images/about-img.jpg') }}" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ asset('orthoc/images/d1.jpg') }}" alt="">
            </div>
            <div class="detail-box">
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ asset('orthoc/images/d2.jpg') }}" alt="">
            </div>
            <div class="detail-box">
              <div class="social_box">
                <a href="">
        ...
        <div class="col-sm-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ asset('orthoc/images/d3.jpg') }}" alt="">
            </div>
            <div class="detail-box">
              <div class="social_box">
                <a href="">
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-md-11 col-lg-10 mx-auto">
                <div class="box">
                  <div class="img-box">
                    <img src="{{ asset('orthoc/images/client.jpg') }}" alt="" />
                  </div>
                  <div class="detail-box">
                    <div class="name">
                      <h6>
  ...
  <!-- jQery -->
  <script type="text/javascript" src="{{ asset('orthoc/js/jquery-3.4.1.min.js') }}"></script>
  <!-- popper js -->
  <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous">
  </script>
  <!-- bootstrap js -->
  <script type="text/javascript" src="{{ asset('orthoc/js/bootstrap.js') }}"></script>
  <!-- owl slider -->
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js">
  </script>
  <!-- custom js -->
  <script type="text/javascript" src="{{ asset('orthoc/js/custom.js') }}"></script>
  <!-- Google Map -->
